...
import {isIos, SocketProvider, useSocket} from '@common';
...
export const MyApp = () => {
    ...
    const { socket, socketInit, socketOff, socketListen,socketEmit, socketDisconnect } = useSocket();


    return (
    <SafeAreaProvider>
      <Provider store={store}>
      <SocketProvider value={{socket, socketInit, socketOff, socketListen,socketEmit, socketDisconnect}}>
