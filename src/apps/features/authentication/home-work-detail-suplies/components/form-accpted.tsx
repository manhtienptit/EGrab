  ...
  return (
    <FormProvider {...formMethod}>
        <Block paddingHorizontal={sizeScale(20)} marginTop={sizeScale(20)} >
            { !onReject &&
               <Input<FormLoginType> name={'cost'} label={'Nhập chi phí'}  keyboardType={'number-pad'}/>
            }
              <Spacer height={10}/>
              <Input<FormLoginType> height={sizeScale(120)} name={'note'} label={onReject ? 'Ghi chú' : 'Mô tả thêm'} numberOfLines={5}/>
              <Spacer height={20}/>
